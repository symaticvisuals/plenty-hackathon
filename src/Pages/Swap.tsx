    ...
    <div>
      ...
      <div className="flex justify-center items-center text-3xl text-skin-inverted-dark mt-1">
        <div className="bg-skin-inverted z-20 absolute rounded-full">
          <HiArrowCircleDown
            className=" transform hover:rotate-180 duration-100 transition-all text-skin-inverted-dark"
            onClick={() => {
              setSelectedTokens({
                accepted: "to",
      ...
      <div className="w-[400px] h-[500px] bg-skin-main relative rounded-2xl py-8 px-8">
        ...
        <div className="h-[340px] overflow-y-auto mt-3 flex flex-col">
          {tokenValues.map((token, index) => (
            <div
              key={index}
              className="flex items-center justify-start gap-4 px-3 py-2 rounded-md font-sans text-skin-inverted-dark hover:bg-slate-400/30" onClick={
                () => {
                  selectedTokens.accepted === "from"? setSelectedTokens({...selectedTokens, from: token}) : setSelectedTokens({...selectedTokens, to: token})
                  setOpen(false);
                }
              }>
              <img
