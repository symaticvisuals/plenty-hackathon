    ...
    <div className="mt-10">
      ...
      <div className="grid grid-cols-4 gap-4 px-8 xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
        {toolsData.map((toolsData, index) => (
          <div className="mt-12 cursor-pointer p-3 px-6 py-5 w-full  min-h-[20vh] bg-skin-main rounded-xl flex flex-col items-center border justify-center dark:border-none dark:shadow-slate-800  hover:shadow-lg" key={index}>
